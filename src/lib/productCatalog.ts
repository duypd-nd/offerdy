...
import type { CatalogProduct } from '@/lib/productMatch'

// Tai xuat de cac noi dang import tu day khong phai doi.
export { tokenize, meaningfulTokens, modelCodes, suggestProducts } from '@/lib/productMatch'
export type { CatalogProduct, Suggestion } from '@/lib/productMatch'
