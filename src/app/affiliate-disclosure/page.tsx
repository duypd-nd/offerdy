...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return { title: fillSiteName(d.seoTitle, siteName), description: fillSiteName(d.seoDescription, siteName), alternates: { canonical: '/affiliate-disclosure' }, robots: d.indexPage ? undefined : { index: false } }
}
