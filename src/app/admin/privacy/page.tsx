...
const SECTIONS = [
  ...
  { _key: 's3', heading: 'Cookies and Tracking', body: '{site} uses cookies for analytics and to track affiliate referrals. See our <a href="/cookies">Cookie Policy</a> for detailed information on the cookies we use and how to manage them.' },
  ...
  { _key: 's8', heading: 'Changes to This Policy', body: 'We may update this Privacy Policy from time to time. We will post the updated date at the top of this page. Continued use of {site} constitutes acceptance of any changes.' },
...
export default async function PrivacyAdminPage() {
  ...
  return (
    <LegalForm
      ...
      defaultSeoTitle="Privacy Policy — {site}"
      defaultSeoDesc="Read {site}'s Privacy Policy. We explain what data we collect, how we use it, and your rights."
