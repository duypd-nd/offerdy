...
export default async function CookiesAdminPage() {
  ...
  return (
    <LegalForm
      ...
      defaultSeoTitle="Cookie Policy — {site}"
      defaultSeoDesc="Learn how {site} uses cookies for analytics and affiliate tracking, and how to manage your cookie preferences."
