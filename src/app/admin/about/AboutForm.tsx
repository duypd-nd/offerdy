...
const DEFAULTS: Required<AboutData> = {
  ...
  categories: [
    { _key: 'cat1', title: 'Fashion & Apparel', desc: 'VisoOne Eyewear, Apollo Moda, Estarer, Cottagecore Clothes, Savransky Private Jeweler and other independent brands — clothing, footwear, eyewear and jewellery.' },
    { _key: 'cat2', title: 'Home & Living', desc: 'Frizzlife, SleepBamboo, Cocon de Lune, LightStyl, Vonluce and more — water filtration, bedding, lighting and furniture.' },
    { _key: 'cat3', title: 'Electronics & Gadgets', desc: 'Redodo Power, Carlinkit CarPlay Store, Ohmmu, Bodegacooler, WoWGadgets99 — batteries, car tech, appliances and accessories.' },
