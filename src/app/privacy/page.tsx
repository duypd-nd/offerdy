...
const DEFAULTS = {
  ...
  seoDescription: "Read {site}'s Privacy Policy. We explain what data we collect, how we use it, and your rights.",
  indexPage: true,
}
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return { title: fillSiteName(d.seoTitle, siteName), description: fillSiteName(d.seoDescription, siteName), alternates: { canonical: `${BASE}/privacy` }, robots: d.indexPage ? undefined : { index: false } }
}
